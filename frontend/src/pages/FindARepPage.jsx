...
const FindARepPage = () => {
  ...
  const getRep = (stateCode) => {
    ...
    return demoReps.find(rep => rep.states.includes(stateCode));
  };
      ...
      <div className="container">
              ...
              >
                <Card>
                  <div className="text-center mb-6">
                    ...
                    <p className="text-sm text-dark-100">{displayRep.territory}</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-dark-200">{displayRep.states.join(', ')}</p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {demoReps.map((rep) => (
              <Card key={rep.id} className="hover:shadow-xl hover:border-primary-500 transition-all cursor-pointer" onClick={() => setSelectedState(rep.states[0])}>
                <h3 className="text-lg font-semibold mb-1 text-dark-50">{rep.name}</h3>
                <p className="text-sm text-dark-100 mb-3">{rep.territory}</p>
                <div className="space-y-1 text-sm">
                  <p className="text-dark-200">
                    <strong className="text-dark-50">States:</strong> {rep.states.join(', ')}
                  </p>
