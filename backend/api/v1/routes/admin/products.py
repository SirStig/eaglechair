            ...
            products_data[i]["variations"] = [
                {
                    ...
                    "depth": getattr(v, "depth", None),
                    "height": getattr(v, "height", None),
                    "seat_width": getattr(v, "seat_width", None),
                    "seat_depth": getattr(v, "seat_depth", None),
                    "seat_height": getattr(v, "seat_height", None),
                    "arm_height": getattr(v, "arm_height", None),
                    "back_height": getattr(v, "back_height", None),
                    "additional_dimensions": getattr(v, "additional_dimensions", None),
                    "weight": getattr(v, "weight", None),
                    "shipping_weight": getattr(v, "shipping_weight", None),
                    "upholstery_amount": getattr(v, "upholstery_amount", None),
